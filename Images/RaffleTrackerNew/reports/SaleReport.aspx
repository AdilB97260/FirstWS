<%@ Page Title="" Language="C#" MasterPageFile="~/RaffleTracker.master" AutoEventWireup="true"
    CodeFile="SaleReport.aspx.cs" Inherits="reports_SaleReport" %>
        ...
        $(function () {
            ...
            $("#GenRep").click(function () {
                $.ajax({
                    ...
                    url: '/Reports/SaleReport.aspx/GetData',
                    data: "{noOfCount:" + 0 + "}",
                    success:
                    function (response) {
        ...
        <div class="col-lg-12 col-md-12" style="padding-top: 15px">
            <div class="col-lg-12 col-sm-12">
                <div class="filterContent sidebarWidget register-form" style="border: none!important;">
                    <div class="row">
                        <div class="col-lg-12 col-sm-12">
                            <div class="col-lg-2 col-sm-2" style="padding-top:8px">
                                <label>
                                    Select Top Sales count
                                </label>
                            </div>
