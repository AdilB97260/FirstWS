<%@ Page Title="" Language="C#" MasterPageFile="../RaffleTracker.master" AutoEventWireup="true"
    CodeFile="ChurchRegistration.aspx.cs" Inherits="ChurchRegistration" %>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="formBlock">
                                                    ...
                                                    <asp:TextBox runat="server" ID="txtUserName" placeholder="Enter Name Of Church" class="formcontrol"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="formBlock">
                                                    ...
                                                    <asp:TextBox runat="server" ID="txtChurchAdmName" placeholder="Enter Name Of Church Administrator"
                                                        class="formcontrol" MaxLength="100"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="formBlock">
