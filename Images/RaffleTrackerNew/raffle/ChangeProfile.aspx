...
<asp:Content ID="Content1" ContentPlaceHolderID="header" runat="Server">
    <script type="text/javascript">
        ...
        function ValidateForm() {
            ...
            var IsValid = true;
            var arrControls = ["txtUserName", "txtLoginName", "txtAdd"];
        ...
        function ValidatePassword() {
            ...
            var IsValid = true;
            var arrControls = ["txtOldPassword", "txtNewPass", "txtConfirmPass"];
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                             ...
                                             <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="formBlock">
                                                    ...
                                                    <span style="color: red; padding: 3px 0 0 3px; font-size: 12px;">*</span>
                                                    <asp:TextBox runat="server" ID="txtLoginName" placeholder="Enter User Name for login" class="formcontrol"
                                                ...
                                                <div class="formBlock" style="padding-top: 15px;">
                                                    <div class="row">
                                                        <div class="col-lg-5 col-md-5 ">
                                                            <asp:Button Text="Save" ID="btnSavePass" runat="server" CssClass="buttonColor" OnClientClick="return ValidatePassword()"
