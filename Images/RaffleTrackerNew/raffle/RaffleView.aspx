<%@ Page Title="" Language="C#" MasterPageFile="~/RaffleTracker.master" AutoEventWireup="true"
    CodeFile="RaffleView.aspx.cs" Inherits="Raffle_RaffleView" %>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <h1 style="padding-top: 10px; padding-bottom: 15px">
                                Raffle Ticket Distribution To Churches</h1>
                            <span style="float: right;">
                                ...
                                <asp:Button Text="Add more tickets for Raffle" ID="btnAddTicket" runat="server" class="buttonColor"
            ...
            <div class="col-lg-12 col-sm-12">
                <div class="filterContent sidebarWidget register-form" style="border: none!important;">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <h1>
                                Super Admin Ticket Distribution To Raffle
                            </h1>
                            <div class="divider">
                            </div>
                        </div>
