<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/Inventory.master" AutoEventWireup="true" CodeFile="SubHeadingMaster.aspx.cs" Inherits="Inventory_SubHeadingMaster" %>
                                              ...
                                              <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="formBlock">
                                                  ...
                                                  Sub Heading 
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtSubHeading" ErrorMessage="Please enter SubHeading " Display="Dynamic" ValidationGroup="vldExp" Font-Size="9" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    <asp:TextBox runat="server" ID="txtSubHeading" ClientIDMode="Static" placeholder="Enter Sub Heading " class="formcontrol"
