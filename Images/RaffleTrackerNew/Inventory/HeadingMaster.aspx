<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/Inventory.master" AutoEventWireup="true" CodeFile="HeadingMaster.aspx.cs" Inherits="Inventory_HeadingMaster" %>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="formBlock">
                                                  ...
                                                  Heading 
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtheading" ErrorMessage="Please enter Heading " Display="Dynamic" ValidationGroup="vldExp" Font-Size="9" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    <asp:TextBox runat="server" ID="txtheading" ClientIDMode="Static" placeholder="Enter Heading " class="formcontrol"
