<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/Inventory.master" AutoEventWireup="true" CodeFile="ManageCategory.aspx.cs" Inherits="Inventory_ManageCategory" %>
                                             ...
                                             <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="formBlock">
                                                   ...
                                                   Category Name
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtName" ErrorMessage="Please enter Category Name" Display="Dynamic" ValidationGroup="vldExp" Font-Size="9" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    <asp:TextBox runat="server" ID="txtName" ClientIDMode="Static" placeholder="Enter Category Name" class="formcontrol"
