...
<asp:Content ID="Content1" ContentPlaceHolderID="header" runat="Server">
    <script type="text/javascript">
        ...
        function DeleteSale(id) {
            jConfirm('Are you sure for delete Sold Ticket  ?', 'Confirmation', function (r) {
                if (r) {
                    $.ajax({
                        type: "POST",
                        url: "/Member/EditMember.aspx/DeleteSale",
                        data: "{tid: '" + id + "'}",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
        ...
        function DeleteUser(id) {
            jConfirm('Are you sure want to Delete Member ?', 'Confirmation', function (r) {
                if (r) {
                    $.ajax({
                        type: "POST",
                        url: "/Member/EditMember.aspx/DeleteUser",
                        data: "{tid: '" + id + "'}",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (response) {
                            if (response.d == "true") {
                                jAlert("Member deleted successfully.", "Delete Successs", true, "/Church/dashboard.aspx");
        ...
        function btnSaveReDist() {
            ...
            if (validate) {
                $.ajax({
                    type: "POST",
                    url: "/member/EditMember.aspx/ReDistTicket",
        ...
        function btnSaveEdit() {
             ...
             if (validate) {
                 ...
                 $.ajax({
                     type: "POST",
                     url: "/member/EditMember.aspx/EditTicket",
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            ...
                            <span style="float: right;">
                                ...
                                <a href="javascript:;" class="buttonColor" id="adelete" onclick="DeleteUser(<%= UserSession.Inst.MemberPK %>)"
                                    style="text-decoration: none; margin-top: 5px">Delete Member</a>&nbsp;&nbsp;
                            </span>
                            <div class="divider">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <h1 style="text-transform: none">
                                Member Get Ticket From Church</h1>
                            <div class="divider">
                            </div>
                        </div>
                    </div>
                                            ...
                                            <asp:Repeater runat="server" ID="rptDistribution">
                                                <ItemTemplate>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <% if (UserSession.Inst.UserType == "ADMIN" || UserSession.Inst.UserType == "CHURCH")
                                                           { %>
                                                        <td>
            ...
            <div class="col-lg-12 col-sm-12">
                <div class="filterContent sidebarWidget register-form" style="border: none!important;">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <h1 style="text-transform: none">
                                Member Ticket Distribution To Other Members</h1>
                            <div class="divider">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="panel-body" style="padding-top: 1px">
                            ...
                            <div class="col-lg-12" style="text-align: right; padding-right: 42%">
                                <b style="color: Maroon">Total Ticket Distribution to Other Members&nbsp;: </b>&nbsp;&nbsp;<asp:Label
            ...
            <div class="col-lg-12 col-sm-12">
                <div class="filterContent sidebarWidget register-form" style="border: none!important;">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <h1 style="text-transform: none">
                                Member Ticket Sold To Friend</h1>
                            <div class="divider">
                            </div>
                        </div>
                    </div>
