<%@ Page Title="" Language="C#" MasterPageFile="~/RaffleTracker.master" AutoEventWireup="true" CodeFile="NewDashBoard.aspx.cs" Inherits="member2member_NewDashBoard" %>
            ...
            <div class="col-lg-12 col-sm-12">
                <div class="filterContent sidebarWidget register-form" style="min-height: 480px; border: none!important;">
                    <div class="row" style="padding-top: 20px;">
                        ...
                        <div class="col-md-3 col-xl-4">
                            <div class="card mb-3 widget-content bg-midnight-bloom" style="height: 76px">
                    ...
                    <div class="row" style="margin-top: 20px;">
                        <div class="col-md-6">
                            ...
                            <div class="main-card mb-3 card">
                                <div class="col-lg-4 col-md-4">
                                    <asp:Button Text="Disribution" ID="btnDistribution" runat="server" CssClass="buttonColor" OnClick="btnDistribution_Click"  />
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="main-card mb-3 card">
                                <div class="col-lg-4 col-md-4">
                                    <asp:Button Text="Sales List" ID="btnSell" runat="server" CssClass="buttonColor" OnClick="btnSell_Click"  />
                                </div>
                                <div class="card-body">
                                    <h5 class="card-title" style="margin-top: 0px!important">Latest Ticket Sell</h5>
                                    <table class="mb-0 table table-striped">
                                        <thead>
                                            <tr>
                                                <th>Time Stamp</th>
