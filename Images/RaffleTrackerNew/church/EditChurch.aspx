<%@ Page Title="" Language="C#" MasterPageFile="~/RaffleTracker.master" AutoEventWireup="true"
    CodeFile="EditChurch.aspx.cs" Inherits="Church_EditChurch" %>

<asp:Content ID="Content1" ContentPlaceHolderID="header" runat="Server">
    <script type="text/javascript">

        function DeleteUser(id) {
            jConfirm('Are you sure want to Delete Church ?', 'Confirmation', function (r) {
                if (r) {
                    $.ajax({
                        type: "POST",
                        url: "/church/EditChurch.aspx/DeleteUser",
                        data: "{tid: '" + id + "'}",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (response) {
                            if (response.d == "true") {
                                jAlert("Raffle deleted successfully.", "Delete Successs", true, "/Raffle/dashboard.aspx");
        ...
        function DeleteDistribution(id) {
            jConfirm('Are you sure want to delete ticket distribution ?', 'Confirmation', function (r) {
                if (r) {
                    $.ajax({
                        type: "POST",
                        url: "/Church/Editchurch.aspx/DeleteDistribution",
                        data: "{tid: '" + id + "'}",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (response) {
        ...
        function DeleteSale(id) {
            jConfirm('Are you sure for delete Sold Ticket  ?', 'Confirmation', function (r) {
                if (r) {
                    $.ajax({
                        type: "POST",
                        url: "/Church/EditChurch.aspx/DeleteSale",
                        data: "{tid: '" + id + "'}",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (response) {
        ...
        function ValidateForm() {
            ...
            var IsValid = true;
            var arrControls = ["txtUserName,txtTicketRate"];
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            ...
                            <span style="float: right;">
                                ...
                                <%--<asp:Button Text="Add more ticket for Church" ID="btnAddTicket" runat="server" class="buttonColor"
                                    OnClick="btnAddTicket_Click" />--%>
                                <a href="javascript:;" class="buttonColor" id="adelete" onclick="DeleteUser(<%= UserSession.Inst.ChurchPK %>)"
                                    style="text-decoration: none; margin-top: 5px">Delete Church</a>&nbsp;&nbsp;
                            </span>
                            <div class="divider">
                            </div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                             ...
                                             <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="formBlock">
                                                    <label>
                                                        Church Type</label>
                                                    <asp:DropDownList ID="ddlChurchType" CssClass="formDropdown1 formcontrol" runat="server">
                                                        <asp:ListItem Text="Parnter" Value="PARTNER" Selected="True"></asp:ListItem>
                                            ...
                                            <% if (UserSession.Inst.UserType == "ADMIN")
                                               { %>
                                            <div class="col-lg-5 col-md-5" style="float:right; padding-top:15px"> 
                                                <asp:Button Text="Update Sale as per Ticket Rate" ID="btnUpdateSale" runat="server"
                                                    CssClass="buttonColor" OnClick="btnUpdateTicketSale_click" />
                                            </div>
                                            <% } %> 
                                        </div>
                                    </div>
            ...
            <div class="col-lg-12 col-sm-12">
                <div class="filterContent sidebarWidget register-form" style="border: none!important;">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <h1>
                               Tickets Distributed to members by Parish</h1>
                            <div class="divider">
                            </div>
                        </div>
                    </div>
